...
export default function Home() {
  return (
    ...
    <div className="flex justify-center">
      <img src="/home_wall.jpg" width="600" height="2500" />
    </div>
    <section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      <h2 class="text-xs text-pink-500 tracking-widest font-medium title-font mb-1">A trusted E-commerse company</h2>
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">We are with You from beggining to End</h1>
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base">A trusted E-commerse company,We are with You from beggining to End</p>
    </div>
